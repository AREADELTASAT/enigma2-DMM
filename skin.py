...
DEFAULT_SKIN = SystemInfo["HasFullHDSkinSupport"] and "PLi-HD-FullNight/skin.xml" or "MetrixHD/skin.xml"  # SD hardware is no longer supported by the default skin.
